...
// that date they come from full order data. Rows before CLOVER_FROM come from
// the retired Arryved POS (one-time history load, 2026-07-23). Keep eras here,
// in ONE place: the Arryved load added an entry, not scattered edits.

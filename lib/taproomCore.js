...
// (discounts unavailable → always 0; refund days read slightly high); from
// that date they come from full order data. Keep eras here, in ONE place: a
// future Arryved-history load becomes another entry, not scattered edits.
export const ORDERS_ERA_FROM = '2026-05-01'
export const provenanceForDate = (iso) => (iso >= ORDERS_ERA_FROM ? 'orders' : 'payments-rebuild')
